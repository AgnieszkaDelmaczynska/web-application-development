    ...
    <div id="wrapper">
        ...
        <div id="content">
                ...
                <form method="post" enctype="multipart/form-data">
                   <div id="in_content">
                   adres e-mail:<input type="text" name="email" placeholder="adres e-mai" required><br>
                   ...
                   powtórz hasło:<input type="password" name="repeat_pass" placeholder="powtórz hasło" required><br>
                   </div>                             
        ...
        <nav>
            <ul>
                ...
                <li><a class="active" href="#">Zarejestruj się</a></li>                
            </ul>
