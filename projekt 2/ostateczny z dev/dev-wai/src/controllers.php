...
{   
    ...
    //zapisywanie zdjecia   
    $miniaturki = glob("/var/www/dev/src/web/images/mini*.*");
    $znakiwodne=glob("/var/www/dev/src/web/images/imagewm*.*");
    $imagecount = (count(glob("/var/www/dev/src/web/images/*.jpg"))+count(glob("/var/www/dev/src/web/images/*.png"))/3);
    ...
    if (!empty($_POST['zapis_zdjec']))
    {
        ...
        $upload = "/var/www/dev/src/web/images/". $_FILES['zdjecie']['name'];
