...
function zapisz_jpg_w_folderze($upload,$imagecount,$watermark)
{
     ...
     imagejpeg($imageResized,"/var/www/prod/src/web/images/"."mini".$imagecount.".jpg");
     imagejpeg($image,"/var/www/prod/src/web/images/"."imagewm".$imagecount.".jpg");
}
function zapisz_png_w_folderze($upload,$imagecount,$watermark)
{
    ...
    imagepng($imageResized,"/var/www/prod/src/web/images/"."mini".$imagecount.".png");
    imagepng($image,"/var/www/prod/src/web/images/"."imagewm".$imagecount.".png");
}
